#ifndef __NXDK_LOG_H__
#define __NXDK_LOG_H__
...
enum nxLogResult
{
    ...
    //! A socket error occurred. @note The underlying socket API will be uninitalized, if possible.
 ...
 * @return an @link nxLogResult @endlink code.
 */
